att.PrintName = "Re-engineered Energy Cell Prototype #3281" --smg1
...
att.Desc_Cons = {
    ...
    "Requires at least 5 Suit Energy",
...
att.Hook_BulletHit = function(wep, data)
    ...
    if wep.Owner:Armor() >= 4 then
        data.damage = data.damage * 5
        wep.Owner:SetArmor(wep.Owner:Armor() - 4)
    end
end
att.NotForNPC = true

att.Hook_Compatible = function(wep)
    if wep.Num ~= 1 or (wep.Primary.Ammo ~= "smg1") then return false end
end
