att.PrintName = "Polymer Coated Bullets"
att.AbbrevName = "PC Bullets"
att.Icon = Material("entities/att/placeholder_blackmod.png")
att.Description = [[Cleaner, cheaper, more accurate, and most importantly: purple. These are the four key elements of PC (Polymer Coated) Bullets. The aforementioned polymer coating reportedly reduces friction, lead fouling, and wear inside the barrel, as well as reduce the splash-back on steel targets and reduce smoke.
