att.PrintName = "COMET-40 Rocket Propelled Grenade Launcher"
att.AbbrevName = "COMET-40"
att.Icon = Material("entities/att/tac_synthesis_placeholder_blackmod.png", "mips smooth")
