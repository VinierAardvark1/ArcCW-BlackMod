att.PrintName = "Re-engineered Energy Cell Prototype #3278" --ar2
...
att.Hook_BulletHit = function(wep, data)
    ...
    if wep.Owner:Armor() >= 5 then
        data.damage = data.damage * 5
        wep.Owner:SetArmor(wep.Owner:Armor() - 5)
    end
end
att.NotForNPC = true

att.Hook_Compatible = function(wep)
    if wep.Num ~= 1 or (wep.Primary.Ammo ~= "ar2") then return false end
end