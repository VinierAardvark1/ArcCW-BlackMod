...
att.RequireFlags = {"ur_dbs_barrel_sawedoffplus", "ur_dbs_fg_extractor", "uc_tp_runandgun"}
att.HideIfBlocked = true
att.Free = true

att.Hook_Compatible = function(wep)
    return table.HasValue({"arccw_ur_db"}, wep.ClassName) --Urban Renewal IZH-58 version
end
