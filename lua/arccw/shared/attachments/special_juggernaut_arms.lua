...
att.Description = [[Well, I don't know how you did it. Maybe you're a robot, or worked out a lot, or maybe you're just a cheater; point is, you can control the Juggernaut's own minigun... Oh I feel kinda sorry for whoever you might face. Ah, but not really. Have fun!]]
att.Desc_Pros = {
    "Probably a robot",
    "Probably strong af",
}
