att.PrintName = "Re-engineered Energy Cell Prototype #3277" --357
...
att.Desc_Cons = {
    ...
    "Requires at least 15 Suit Energy.",
...
att.Mult_HeatCapacity = 0.1
att.Mult_FixTime = 2
att.Mult_HeatDissipation = 1.5
att.Mult_HeatDelayTime = 4
...
att.Hook_Compatible = function(wep)
    if wep.Num ~= 1 or (wep.Primary.Ammo ~= "357") then return false end
end
